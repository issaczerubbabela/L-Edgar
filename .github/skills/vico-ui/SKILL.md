---
name: vico-ui
description: Vico charting library for Android. Use when building Cartesian charts (line, column/bar), formatting axes, styling with Material 3 themes, or implementing custom markers. Covers Vico 2.x API with CartesianChartHost and CartesianChartModelProducer patterns.
argument-hint: "Describe the chart type (line, bar, column) and data requirements"
---
...
- Building line charts, bar charts, and column charts
- Formatting axes with custom value formatters
- Styling charts with Material 3 themes and color schemes
- Implementing interactive markers/tooltips
- Animating chart data updates in ViewModels
