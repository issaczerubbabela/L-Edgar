...
class SyncWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        return try {
            ...
            val bucketBackupCount = backupBucketBudgets(scriptUrl) ?: run {
                return Result.failure(workDataOf(KEY_ERROR_MESSAGE to (lastSyncError ?: "Bucket backup failed")))
            }
            ...
            Result.success(
                workDataOf(
                    ...
                    KEY_BUCKET_BACKUP_COUNT to bucketBackupCount,
